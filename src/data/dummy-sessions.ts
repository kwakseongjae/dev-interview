    ...
    questions: [
      {
        ...
        category: "React",
        answer: "Virtual DOM은 실제 DOM의 가상 복사본으로, React에서 UI 업데이트를 효율적으로 처리하기 위해 사용됩니다. 변경사항이 발생하면 새로운 Virtual DOM을 생성하고, 이전 Virtual DOM과 비교(Diffing)하여 실제로 변경된 부분만 실제 DOM에 반영합니다.",
        timeSpent: 165,
        isAnswered: true,
        isFavorite: true,
      },
      {
        ...
        answer: "Redux는 Flux 패턴을 기반으로 한 예측 가능한 상태 관리를 제공하지만 보일러플레이트가 많습니다. Recoil은 Atomic 단위의 상태 관리로 React에 최적화되어 있고, Zustand는 간단한 API로 빠른 개발이 가능합니다.",
        timeSpent: 152,
        isAnswered: true,
        isFavorite: false,
      },
      {
        ...
        answer: "Code Splitting을 통해 초기 로딩 시간을 줄이고, React.lazy와 Suspense로 컴포넌트 레벨의 Lazy Loading을 구현했습니다. 이미지는 WebP 포맷과 lazy loading 속성을 활용했고, webpack-bundle-analyzer로 번들 사이즈를 분석하여 불필요한 의존성을 제거했습니다.",
        timeSpent: 170,
        isAnswered: true,
        isFavorite: true,
      },
      {
        ...
        category: "TypeScript",
        answer: "Generic을 활용해 재사용 가능한 컴포넌트를 만들고, Union 타입으로 다양한 상태를 표현했습니다. Type Guard로 런타임에서 타입을 좁히고, Utility Types(Partial, Pick, Omit 등)로 기존 타입을 변형하여 사용했습니다.",
        timeSpent: 148,
        isAnswered: true,
        isFavorite: false,
      },
      {
        ...
        category: "Testing",
        answer: "Jest와 React Testing Library로 컴포넌트 단위 테스트를 작성하고, Cypress로 E2E 테스트를 구현했습니다. 테스트 피라미드를 고려하여 단위 테스트 비중을 높게 유지하고, 중요한 사용자 플로우는 E2E로 검증했습니다.",
        timeSpent: 120,
        isAnswered: true,
        isFavorite: false,
      },
    ...
    questions: [
      {
        ...
        category: "API Design",
        answer: "RESTful API는 리소스 중심의 설계 원칙을 따릅니다. HTTP 메서드를 적절히 활용하고, 명확한 상태 코드를 반환하며, URI는 명사형 리소스로 표현했습니다.",
        timeSpent: 130,
        isAnswered: true,
        isFavorite: true,
      },
      {
        ...
        category: "Database",
        answer: "자주 조회되는 컬럼에 인덱스를 생성하고, 복합 인덱스의 컬럼 순서를 고려했습니다. EXPLAIN으로 실행 계획을 분석하고 N+1 문제는 JOIN이나 Eager Loading으로 해결했습니다.",
        timeSpent: 145,
        isAnswered: true,
        isFavorite: false,
      },
      {
        ...
        answer: "마이크로서비스는 독립적인 배포와 확장이 가능하지만, 서비스 간 통신 복잡성과 데이터 일관성 관리가 어렵습니다. 도메인 기반으로 서비스를 분리하고 이벤트 기반 통신을 활용했습니다.",
        timeSpent: 160,
        isAnswered: true,
        isFavorite: false,
      },
      {
        ...
        category: "Security",
        answer: "JWT 기반 인증을 구현하고 Access/Refresh 토큰을 분리했습니다. RBAC으로 권한을 관리하고, CORS 설정으로 허용된 도메인만 접근 가능하도록 했습니다.",
        timeSpent: 112,
        isAnswered: true,
        isFavorite: true,
      },
